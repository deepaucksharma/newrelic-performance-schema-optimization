...
echo ""
echo "3. Add an inbound rule on the RDS/Aurora security group to allow TCP 3306 from the Lambda security group ID output by the stack (e.g. nr-mysql-ps-lambda-sg)"
echo ""
echo "4. Reboot your database instance"
echo ""
echo "5. Verify the configuration with:"
